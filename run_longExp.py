...
parser.add_argument('--memd_num_directions', type=int, default='10', help='memd_num_directions')
parser.add_argument('--max_imfs', type=int, default='5', help='max_imfs')
# GPU
...
parser.add_argument('--expand', type=int, default=2, help='Mamba block expansion factor')
